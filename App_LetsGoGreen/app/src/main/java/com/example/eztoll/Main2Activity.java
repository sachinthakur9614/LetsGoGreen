...
/*
        Button hamMenu = findViewById(R.id.button3);
...
*/
        ...
        //String ppic = currentUser.getPhotoUrl().toString();

/*
        textView1  = (TextView)findViewById(R.id.ttextView1);
        textView1.setText(name);

        textView2  = (TextView)findViewById(R.id.ttextView2);
        textView2.setText(email);
*/

        cv_github = (CardView)findViewById(R.id.send_image);
        sendlocation = (CardView)findViewById(R.id.send_cur_location);
        ...
        sendlocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(Main2Activity.this, "Logout Successfull", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(getApplicationContext(), GetcurrentlocationActivity.class);
                startActivity(intent);
            }
        });
